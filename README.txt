...
1) Convert header fields to match schema fields:
   - course,program,title,edition,year,author,id,alternate_isbns,call_number,bar_code,current_status,new_returning_past_semester,umcp_copy,comment,test_notes
2) Run command:
